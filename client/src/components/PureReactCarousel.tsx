          ...
          <CarouselProvider naturalSlideWidth={100} naturalSlideHeight={windowBreakPoint(windowWidth)} totalSlides={slides.length}>
               <div className="relative">
                    ...
                    <div className="absolute top-0 left-0 w-full flex flex-col justify-between h-full p-4 bg-gradient-to-r from-black via-transparent to-transparent rounded-l-xl">
                         <p className="text-orange-600 font-medium lg:text-3xl sm:text-sm screen320:text-sm">Recettes à la une</p>
                         <p className="text-white">
                              <span className="font-semibold lg:text-2xl sm:text-sm screen320:text-sm">Mike's famous salad <br /> with cheese</span> <br />
                              <span className="font-semibold lg:text-sm  sm:text-xs screen320:text-xs">By John Mike</span>
                         </p>
